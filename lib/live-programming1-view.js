...
function createExamples(eList) {
  ...
  for (var i=0; i < eList.length; i++) {
    htmlExamples += '<li /><input type=\'checkbox\' id=\'lock\' class=\'lock\'><button id=\'x\' class=\'x\'>×</button>' + eList[i];
  }
...
class LiveProgrammingView {
  ...
  render() {
    return <div>
      ...
      <p>The program will dynamically add outputs based on your code.
      <br>
      You are free to add, remove, or lock outputs to affect how the code will change.</p>
